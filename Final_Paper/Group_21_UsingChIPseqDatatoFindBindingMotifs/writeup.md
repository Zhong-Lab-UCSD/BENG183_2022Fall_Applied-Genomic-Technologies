...
(<https://link.springer.com/article/10.1186/1471-2105-11-396>
...
Personal Screenshot From Genome Browser: The hg38 Reference Genome Search Bar
...
Personal Screenshot From Genome Browser: Three Transcript Variants of the CHRAC1 gene
...
Personal Screenshot From Genome Browser: Section Highlighted from Click and Drag and the Corresponding Pop-up
...
Personal Screenshots From Genome Browser: Human Gene ZDHHC13 After Clicking It on the Window; Section Highlighted From Its mRNA sequence; BLAT Search Results From mRNA Sequence; and Short Match Under the Mapping and Sequencing Dropdown Which Takes You to Match 2-30 Nucleotides
...
Fig 3.1 UCSC Genome Browser Home Page
 

Fig 3.2 Nextstrain Tracks
...
Fig 3.4 Clades and Mutations Track
...
Fig 3.5 Fundamentals of Phylogenetic Trees
...
Fig 3.6 Transmission of SARS-CoV-2 by region
...
Motif Analysis Software
	When it comes to bioinformatics software that perform motif analysis, there are a couple options.  HOMER (developed at UCSD!) is a command line tool with a variety of options for more advanced analysis.  Alternatively, the MEME suite offers a browser based tool for quick motif analysis without having to faff about with installation and learning a new tool.  Both of these tools are capable of both known motifs and de novo motif analysis.
